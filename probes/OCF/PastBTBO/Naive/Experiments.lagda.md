...
这是**共尾度为 Ω 的基本列** (按 [BTBO.lagda.md:537](../../../../src/OCF/BTBO.lagda.md#L537) 的表格, Ord₀ 的上确界是 Ω). 要把它嵌入 Ordᴰ, 需要 Ordᴰ 支持 Ord₀-索引的 `lim` —— 但 Ordᴰ 的 `lim` 只接受 `ℕ → Ordᴰ`.
...
但 **Ord₀ 的 `lim f` 不携带 f 的单调性证明** ([BTBO.lagda.md:843](../../../../src/OCF/BTBO.lagda.md#L843)). f n 和 f m 之间可以是任意关系 (递增、递减、混乱). 没办法套用 Ordᴰ 的 `<-dec` 那一套 ([BTBO.lagda.md:704-707](../../../../src/OCF/BTBO.lagda.md#L704-L707)).
