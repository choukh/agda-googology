...
完整 ψ-folding 基础设施, 镜像 [BTBO L959-1037](../../../src/OCF/BTBO.lagda.md#L959):
- `_+₁_` Ord₁ ℓ 上的加法
- `iter₁` + `lfp₁` 最小不动点
...
类比 [BTBO Ord-Ord 的 `_+_`](../../../src/OCF/BTBO.lagda.md#L960-L964):
...
类比 [BTBO L981-986](../../../src/OCF/BTBO.lagda.md#L981):
...
类比 [BTBO ψ<](../../../src/OCF/BTBO.lagda.md#L1009-L1016) — 关键: limᵢ case 用 `<₁-dec` 派发 (Ord₁ᴰ 的 BoundedTrich, Phase B 已证).
...
类比 [BTBO ψ₀](../../../src/OCF/BTBO.lagda.md#L1033-L1036). 把 Ord₁ ℓ 折叠到 Ord₁ zero (基础序数, ≈ Ordᴰ).
