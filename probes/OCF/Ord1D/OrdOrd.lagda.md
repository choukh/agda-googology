...
把 [BTBO Ord-Ord 模块](../../../src/OCF/BTBO.lagda.md#L836-L944) 完整移植到 Ord₁ᴰ-参数化:
...
类比 [BTBO Ord<-≡](../../../src/OCF/BTBO.lagda.md#L878). 证明 Ord<₁ i p 不依赖 p 的具体证明:
...
类比 [BTBO ↑](../../../src/OCF/BTBO.lagda.md#L911). 给定 p : ℓ₁ <₁ ℓ₂, 把 Ord₁ ℓ₁ 嵌入 Ord₁ ℓ₂:
