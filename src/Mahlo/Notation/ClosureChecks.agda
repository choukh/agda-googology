...
module Mahlo.Notation.ClosureChecks where
...
open import Mahlo.Notation.FiniteSupport using (Any; here; there; All; _∈_; first)
open import Mahlo.Notation.Closure
