...
module Mahlo.Notation.SyntaxChecks where

open import Agda.Builtin.Bool using (true; false)
open import Agda.Builtin.Unit using (⊤; tt)
open import Agda.Builtin.Sigma using (_,_)
open import Agda.Builtin.Equality using (_≡_; refl)
open import Mahlo.Notation.FiniteSupport using (Dec; yes; no; Empty)
open import Mahlo.Notation.Syntax
open import Mahlo.Notation.SyntaxBridge using (encode; flatten; canonicalize)
import Mahlo.Notation.Closure as C
