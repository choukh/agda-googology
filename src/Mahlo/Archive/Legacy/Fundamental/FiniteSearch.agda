...
module Mahlo.Archive.Legacy.Fundamental.FiniteSearch where
...
open import Mahlo.Archive.Legacy.Notation.Syntax using (Term; Principal; nil; cons; phi; psi; omega; mahlo)
open import Mahlo.Archive.Legacy.Notation.FiniteSupport using (_++_)
