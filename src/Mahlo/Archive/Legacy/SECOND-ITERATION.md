...
```sh
agda --no-libraries -i src src/Mahlo/Archive/Legacy/Universe/GeneratedCode.agda
agda --no-libraries -i src src/Mahlo/Archive/Legacy/WellOrder/SmallCover.agda
tools/check-src.sh
```
