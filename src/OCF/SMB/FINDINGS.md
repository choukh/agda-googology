...
诉求 (回顾 [PastBTBO/Naive/FINDINGS §5.1](../PastBTBO/Naive/FINDINGS.md)):
...
**结论**: SMB 的 indMax 在 Tree 上工作, 但**桥接回 Ordᴰ 必撞 +-lmono**. 与 [PastBTBO/Naive/FINDINGS §5.3](../PastBTBO/Naive/FINDINGS.md) 一致 — `+_` 的左非单调是 Ordᴰ 上的结构性真相, SMB 不能改变.
...
与 [PastBTBO/Mahlo/FINDINGS §3-5](../PastBTBO/Mahlo/FINDINGS.md) 撞墙诊断同源 — 跨函数像的决策性是 Brouwer-tree-paradigm 的天花板.
