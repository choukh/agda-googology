---
title: 形式化大数数学 (1.3 - 无限元Veblen函数)
zhihu-tags: Agda, 序数, 大数数学
zhihu-url: https://zhuanlan.zhihu.com/p/707292191
---

# 形式化大数数学 (1.3 - 无限元Veblen函数)
...
$$
\text{SVO}_2 := \lim λn,φ_{\lt ω2,n}\kern{0.17em}1\kern{0.17em}\overset{.}{0}...
$$
...
- 极限阶段: $Φ_{μ}$ 给出了 $μ^+$ 元, 它们是「新的梦的开始」, 其定义的特征是 $\text{jump}_1$
  - $Φ_{ω}$ 给出了 $ω^+$ 元
  - $Φ_{ω2}$ 给出了 $(ω2)^+$ 元
  - ...
- 后继阶段: $Φ_{\lt ν}$ 给出了 $μ^{++}$ 元到 $\lt ν$ 元, 其定义的特征是互递归
  - $Φ_{\lt ω}$ 给出了 $ω$ 元
  - $Φ_{\lt ω2}$ 给出了 $ω2$ 元
  - ...
- 极限阶段: $Φ_{ν}$ 给出了 $ν^{+}$ 元
